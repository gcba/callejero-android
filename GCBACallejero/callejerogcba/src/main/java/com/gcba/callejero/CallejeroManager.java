...
public class CallejeroManager {
    ...
    /**
     * Devuelve un objeto address despues de recibir la latitud y la longitud (SOLO CAPITAL)
     * @param location
   ...
   /* public void loadAddressLaqtLongFromCABA(final AddressLocation location, final LocationCallBack locationCallBack){
    ...
    /** El primer parametro es la calle que se desea normalizar */
    ...
    /**
     * Devuelve una direccion normalizada despues de ingresarle un string valido de calle funciona tanto para provincia como para capital en base al boolean onlyFromCaba
     * @param query
     * @param onlyFromCABA
    ...
    /**
     * Inicia la busqueda de una direccion, mostrando opciones de CABA y Gran Buenos Aires sin poder elegir por pin
     * @param context
     * @param requestCode
     * @param callback
     */
    ...
    /**
     * Inicia la busqueda de una direccion
     * @param context
     * @param requestCode
     * @param callback
     */
